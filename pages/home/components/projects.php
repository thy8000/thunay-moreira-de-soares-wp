        ...
        <div class="flex flex-col">
            ...
            <div class="projects-buttons fade-in-2 flex justify-center items-center flex-wrap gap-4 py-10">
                <a href="#" class="personal-projects__button py-4 px-6 border-2 border-green-500 rounded-full cursor-pointer" x-bind:class="{ 'personal-projects__button__active' : tab === 'all' }" x-on:click.prevent="tab = 'all'">
                    <span class="text-white">Tudo</span>
                </a>

                <a href="#" class="personal-projects__button py-4 px-6 border-2 border-green-500 rounded-full cursor-pointer" x-bind:class="{ 'personal-projects__button__active' : tab === 'web' }" x-on:click.prevent="tab = 'web'">
                    <span class="text-white">Desenvolvimento Web</span>
                </a>

                <a href="#" class="personal-projects__button py-4 px-6 border-2 border-green-500 rounded-full cursor-pointer" x-bind:class="{ 'personal-projects__button__active' : tab === 'games' }" x-on:click.prevent="tab = 'games'">
                    <span class="text-white">Jogos</span>
                </a>

                <a href="#" class="personal-projects__button py-4 px-6 border-2 border-green-500 rounded-full cursor-pointer" x-bind:class="{ 'personal-projects__button__active' : tab === 'mobile' }" x-on:click.prevent="tab = 'mobile'">
                    <span class="text-white">App Mobile</span>
                </a>

                <a href="#" class="personal-projects__button py-4 px-6 border-2 border-green-500 rounded-full cursor-pointer" x-bind:class="{ 'personal-projects__button__active' : tab === 'others' }" x-on:click.prevent="tab = 'others'">
                    <span class="text-white">Outros</span>
                </a>
            </div>

            <div class="projects-grid fade-in-2 grid grid-cols-1 lg:grid-cols-3 gap-4">
                <template x-for="project in projects" x-on:key="data.ID">
