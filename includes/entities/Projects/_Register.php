   ...
   public function register_custom_fields()
   {
      ...
      acf_add_local_field_group([
         ...
         'fields' => [
            ...
            [
               'key' => 'field_67d9c9638a101',
               'label' => __('Lista de descrições', 'thunay'),
               'name' => 'projects_description_list',
               'aria-label' => '',
               'type' => 'repeater',
               'instructions' => '',
               'required' => 0,
               ...
               'max' => 0,
               'collapsed' => '',
               'button_label' => __('Add Row', 'thunay'),
               'rows_per_page' => 20,
               'sub_fields' => [
                  [
                     'key' => 'field_67d9c9808a102',
                     ...
                     'parent_repeater' => 'field_67d9c9638a101',
                  ],
                  [
                     'key' => 'field_67d9c9b18a103',
